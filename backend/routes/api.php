...
// TEMP — one-time recovery for stuck LTR orders from 2026-07-12 closure bug
// Visit: https://api.c-codit.com/api/v1/recover-ltr-orders?s=ccodit2026
// Remove after recovery is confirmed.
Route::get('/v1/recover-ltr-orders', function (\Illuminate\Http\Request $req) {
    if ($req->query('s') !== 'ccodit2026') abort(404);

    $numbers = [
        ['provider_order_id' => '6a52d1719fda754b85c70e0f', 'phone' => '+18283754165', 'code' => '966-400', 'expires_at' => '2026-07-14T23:27:45.993Z'],
        ['provider_order_id' => '6a52d625e9a8314c793ad60e', 'phone' => '+18102884596', 'code' => '283-623', 'expires_at' => '2026-07-14T23:47:49.557Z'],
        ['provider_order_id' => '6a52d7c31606e4835f0afea5', 'phone' => '+15737970100', 'code' => '205-137', 'expires_at' => '2026-07-14T23:54:43.809Z'],
    ...
    foreach ($stuck->values() as $i => $order) {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Log::error('pvadeals.recover_ltr.error', ['order' => $order->public_id, 'error' => $e->getMessage()]);
        }
    }
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'active'])->group(function () {
        ...
        Route::middleware('throttle:api')->prefix('proxy')->group(function () {
            ...
            Route::get('/us-state-availability',         [ProxyController::class, 'usStateAvailability']);
